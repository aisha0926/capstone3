...
export default function RegisterUser() {
  ...
  }, [name, description, email, mobileNumber, password]);

  function registration(e) {
    e.preventDefault();
    console.log(e);

    fetch('https://aqueous-atoll-50380.herokuapp.com/customer/checkEmail', {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        ...
        if (data) {
          ...
          fetch('https://aqueous-atoll-50380.herokuapp.com/seller/register', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
      ...
      <div className='inner_bgcover'>
        <div className='Form__logo'>
          <div className='logo_tinda'>
            ...
            <p className=' span_text text-white'>
              Are you registering as a Customer? Click{' '}
          ...
          <div className='form__reg'>
            ...
            >
              <h1 className='.signup_h1'>Seller Sign up</h1>
